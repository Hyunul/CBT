...
**[필수 첨부: portfolio_benchmark_graph.html 캡처 이미지]**
*(설명: Kafka vs Direct DB 레이턴시 비교 벤치마크 결과 그래프)*
...
*   **검증 (PoC & Benchmark):**
    ...
    *   **결과:** 단순 로직 처리 시 Kafka 도입이 Direct DB 처리 대비 **Latency가 약 4.2배 증가 (2.92ms vs 12.20ms)**함을 확인.
*   **결정 (Decision):**
